...
(define *prim-proc-names* '(+ - * / add1 sub1 zero? not = > >= < <= cons car cdr 
 ...
 quotient apply map positive? negative?)
)
...
(define apply-prim-proc
 (lambda (prim-proc args)
  (case prim-proc
   ...
   ;[(map) (map (lambda (x) (apply-prim-proc (1st args) (list x))) (2nd args))]
   [(map) (map (lambda (x) (apply-prim-proc (cadar args) (list x))) (2nd args))]
